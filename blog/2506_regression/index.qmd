...
#| code-fold: true
#| code-summary: "Click to the R-code used for benchmarking."
...
When we increase the size of the data to 100 variables and an additional intercept for $N = 5000$ observations, we see what we expect to see.
...
#| code-fold: true
#| code-summary: "Click to see the R-code used for benchmarking."
